      ...
      <div className="max-w-6xl">
        ...
        <div className="grid grid-cols-1  gap-6">
          ...
          <div className="space-y-6">
                ...
                <CardContent>
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold capitalize">
                      {users.plan || t("plan.free")} Plan
                    </span>
                    {users.plan && users.plan !== "free" && (
                      <span
                        className={`text-xs font-medium px-2 py-0.5 rounded-full ${
                          users.planExpiry && new Date(users.planExpiry) < new Date()
                  ...
                  {users.planExpiry && (
                    <p className="text-sm text-gray-600 mb-3">
                      {new Date(users.planExpiry) < new Date() ? "Expired on" : t("subscription.renewalDate")}{" "}
                      {new Date(users.planExpiry).toLocaleDateString()}
                    </p>
                  )}
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    >
                      {users.plan && users.plan !== "free" ? t("subscription.changePlan") : t("subscription.upgradePlan")}
                    </Button>
                    <Button
            ...
            {id && (
              <ReputationCard userId={id as string} isOwnProfile={isOwnProfile} />
            )}
